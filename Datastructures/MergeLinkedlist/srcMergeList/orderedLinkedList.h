...
public:
	...
	void merge(orderedLinkedList<Type> &list1, orderedLinkedList<Type> &list2);
	//This operation replaces the list in the class with a new list by merging the
	//elements of list1 and list2.
	//Note: the function will neither create nor destroy any node.
	//Precondition: Both lists list1 and list2 are ordered.
	//Postcondition: first and last point to the first and last node of the merged
	//		list, respectively.  count equals to the sum of counts from list1 and list2.
