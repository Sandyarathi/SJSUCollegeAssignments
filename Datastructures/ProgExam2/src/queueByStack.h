...
#ifndef QUEUEBYSTACK_H_
#define QUEUEBYSTACK_H_
...
public:
    ...
    void addQueue(const Type& queueElement);
      ...
      //Postcondition: If the queue is full, the program
      //    terminates; otherwise the queue is changed and queueElement is
      //    added to the queue.
    ...
    void deleteQueue();
      ...
      //Precondition: The queue exists and is not empty.
      //Postcondition: If the queue is empty, the program
      //    terminates; otherwise the queue is changed and the first element
